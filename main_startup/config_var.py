...
class Config((object)):
    ...
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC", "https://telegra.ph//file/b263d1cfdc81958a4d7a5.jpg"
    )
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/mocpi07/7STAR"
    )
    ALIVE_IMG = os.environ.get(
        "ALIVE_IMG", "https://telegra.ph//file/b263d1cfdc81958a4d7a5.jpg"
    )
    U_BRANCH = "master"
    ...
    XTRA_PLUGINS_REPO = os.environ.get("XTRA_PLUGINS_REPO", "https://github.com/mocpi07/Xtra-Plugins")
